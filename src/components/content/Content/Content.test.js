...
jest.mock('../../../store/selectors/i18n.js', () => ({ getLanguage: () => 'en' }))
jest.mock('../../../store/orm/selectors/section.js', () => ({
...
describe('mapStateToProps', () => {
  ...
  it("returns loading=false if there's a current section", () => {
    mockyGetCurrentSectionPath = () => 'foo'
    mockyGetSection = () => ({ id: 'foo', title: { en: ['title'] }, content: { en: ['foocontent'] } })
    expect(mapStateToProps()).toEqual({
      loading: false,
      section: ({ id: 'foo', title: { en: ['title'] }, content: { en: ['foocontent'] } }),
      currentLanguage: 'en',
    })
  })
})
