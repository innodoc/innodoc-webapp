...
describe('<CheckboxQuestion />', () => {
  it.each([
    ...
    ['1', true, false],
    [null, undefined, true],
  ])('should render: value=%s, checkbox(checked=%s, indeterminate=%s)', (value, checked, indeterminate) => {
    ...
    expect(cb.prop('className')).toMatch('checkbox')
    expect(cb.prop('className')).toMatch('customClass')
