...
import { EMOTION_STYLE_INSERTION_POINT_NAME, EMOTION_STYLE_KEY } from '@innodoc/shared-core/constants'
import getI18n from '@innodoc/shared-core/i18n'
import makeStore from '@innodoc/ui-store'
import { changeRouteTransitionInfo } from '@innodoc/ui-store/slices/app'
