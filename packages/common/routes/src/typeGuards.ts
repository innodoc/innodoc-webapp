...
import builtinRoutes from './routes/builtinRoutes.js'
import courseRoutes, { courseContentRoutes } from './routes/courseRoutes.js'
import userRoutes from './routes/userRoutes.js'
import type { AppRouteInfo, CoursePageRouteInfo, CourseRouteInfo, CourseSectionRouteInfo } from './types/routeInfos.js'
import type { AppRouteName, CourseContentRouteName, RouteName } from './types/routeNames.js'
