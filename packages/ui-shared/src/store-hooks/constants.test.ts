...
import { EMPTY_SECTION_TREE, EMPTY_TRANSLATED_PAGES, EMPTY_TRANSLATED_SECTIONS } from './constants.js'
...
// Their reference stability is what the store hooks rely on, and it is asserted per hook by the
// re-render tests next to them. What no hook exercises is the other half of the contract: the
