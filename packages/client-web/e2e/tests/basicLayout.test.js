...
describe('Basic layout', () => {
  ...
  it('should have content', async () => {
    ...
    await page.waitForSelector('[class^=content___]', '"It was developed at innoCampus"')
    await page.waitForSelector('[class^=content___]', '"It is used for automated software tests."')
  })
